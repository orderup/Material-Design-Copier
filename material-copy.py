...
parser.add_argument('size', type=str, help='Size of icon',choices=['18','24','32','48'])
...
for i in dirs:
    src = i+'_'.join(['ic', args.name.lower(), args.color.lower(), args.size + 'dp.png'])
    out_dir = args.dest+'/'+src.split('/')[2]
